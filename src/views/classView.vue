          ...
          <el-container direction="vertical">
            <div style="position: relative">
              ...
              <div style="position: absolute; right: 10px;">
                ...
                习题：<!--易中难字体问题-->
                <el-link @click="toExe('1', classInfo.courseId, chap)"
                  >易</el-link
                >
                <el-link @click="toExe('2', classInfo.courseId, chap)"
                  >中</el-link
                >
                <el-link @click="toExe('3', classInfo.courseId, chap)"
                  >难</el-link
                >
              </div>
            </div>
